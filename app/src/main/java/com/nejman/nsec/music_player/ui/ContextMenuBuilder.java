...
public class ContextMenuBuilder {
    public static void buildForSearchResult(View sender, String modelInfo)
    {
        ...
        SearchListener action = new SearchListener() {
            @Override
            public void onElement(View sender, String modelInfo, String item) {
        ...
        build(sender, elements, item -> action.onElement(sender, modelInfo, item));
    }
    ...
    public static abstract class TrackListener {
        public abstract void onElement(String filepath, String item, String playlistName);
    }

    public static abstract class SearchListener {
        public abstract void onElement(View sender, String modelInfo, String item);
    }
}
