...
public class TracksAction {
    ...
    public static void remove(String path) {
        DialogFragment dialog = new AlertDialogFragment(MainActivity.getResString(R.string.question_delete) + "?", MainActivity.getResString(R.string.question_delete) + " " + path + "?", MainActivity.getResString(R.string.yes), MainActivity.getResString(R.string.no), confirm -> Tracks.remove(path));
