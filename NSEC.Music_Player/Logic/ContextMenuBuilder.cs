...
namespace NSEC.Music_Player.Logic
{
    public static class ContextMenuBuilder
    {
        ...
        {
            PopupMenu menu = new PopupMenu(MainActivity.Instance, sender, Localization.PlaylistPlay, Localization.SyncAdd, Localization.ChangeName, Localization.TrackMenuDelete);
            menu.OnSelect += async(item) =>
            {
