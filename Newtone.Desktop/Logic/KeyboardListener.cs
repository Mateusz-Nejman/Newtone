        ...
        private IntPtr LowLevelKeyboardProc(int nCode, UIntPtr wParam, IntPtr lParam)
        {
            if (nCode >= 0)
                    ...
                    wParam.ToUInt32() == (int)InterceptKeys.KeyEvent.WM_SYSKEYUP)
                {
                    try
                    {
                        hookedKeyboardCallbackAsync.Invoke((InterceptKeys.KeyEvent)wParam.ToUInt32(), Marshal.ReadInt32(lParam));
        ...
        void KeyboardListener_KeyboardCallbackAsync(InterceptKeys.KeyEvent keyEvent, int vkCode)
        {
            switch (keyEvent)
            {
                ...
                case InterceptKeys.KeyEvent.WM_KEYUP:
                    ...
                    Console.WriteLine(System.Windows.Input.KeyInterop.KeyFromVirtualKey(vkCode));
                    break;
