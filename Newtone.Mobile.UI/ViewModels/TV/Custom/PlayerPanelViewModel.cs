...
namespace Newtone.Mobile.UI.ViewModels.TV.Custom
{
    public class PlayerPanelViewModel : PropertyChangedBase
    {
        ...
        private INFocusElement nextFocusUp;
        private INFocusElement nextFocusUp1;
        #endregion
        ...
        public INFocusElement NextFocusUp1
        {
            get => nextFocusUp1;
            set
            {
            ...
            get
            {
                if (gotoPlayerCommand == null)
                    gotoPlayerCommand = new ActionCommand(async (parameter) =>
                    {
                        if (GlobalData.Current.MediaSource != null)
                        {
                            await Global.NavigationInstance.PushModalAsync(new Views.TV.FullScreenPage());
                        }
                    });
