...
namespace Nejman.Newtone.Mobile.Models
{
    public class PlaylistModel
    {
        ...
        public PlaylistModel(string name, byte[] image)
        {
            Name = name;
        ...
        public ICommand MenuCommand
        {
            get
            {
                if (menuCommand == null)
                    ...
                    {
                        ContextMenuBuilder.BuildForPlaylist((View)parameter, Name);
                    });
        ...
        public ICommand PressedCommand
        {
            get
            {
                if (pressedCommand == null)
                    ...
                    {
                        ShellHelpers.GoTo($"{nameof(TracksListPage)}?{nameof(TracksListViewModel.PlaylistName)}={Name}");
                    });
